...
/** Buffer para armazenar cada linha da fonte de dados evitando carregar toda fonte de dados de uma só vez */
...
/** Retorna o char para o qual o buffer est� apontando atualmente e avan�a o ponteiro para o próximo char */
char nextChar();
