...
/* ################################### Symbol Definition ################################### */
/** Espécies de simbolos (symbol) possíveis */
typedef enum { CONST, VAR, PROCEDURE, PARAM, PARAMLIST } especie;

/** Estrutura de símbolos que compõem a tabela de símbolos */
typedef struct symbol
{
	...
	struct symbol*    next_symbol;	// Ref. para próximo simbolo no escopo
}symbol;
...
/** Função que realiza uma busca até o escopo global da tabela de símbolos
*  <r> symbol* - não symbolo encontrado correspondente ao pId passado;
*  <r> NULL - encontrou.
**/
